...
function boiler_scripts_styles() {
	...
	wp_enqueue_script( 'fancybox', get_template_directory_uri() . '/js/lib/jquery.fancybox.pack.js', '20120206', true );

	wp_enqueue_script( 'fancybox-media', get_template_directory_uri() . '/js/lib/helpers/jquery.fancybox-media.js', '20120206', true );

	wp_enqueue_script( 'boiler-plugins', get_template_directory_uri() . '/js/plugins.js', array(), '20120206', true );

		wp_enqueue_script( 'viewport checker', get_template_directory_uri() . '/js/lib/jquery.viewportchecker.js', '20120206', true );

	wp_enqueue_script( 'parallax', get_template_directory_uri() . '/js/lib/parallax.js', '20120206', true );

	wp_enqueue_script( 'boiler-main', get_template_directory_uri() . '/js/scripts.js', array(), '20120205', true );
